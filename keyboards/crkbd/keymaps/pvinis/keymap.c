...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [LR_SYSCTL] = LAYOUT_split_3x6_3_wrapper(
        ...
        _______, _________________SYSCTL_L3_________________,    _________________SYSCTL_R3_________________, KC_LWIN,
                                   _______, _______, _______,    _______, _______, _______
        // clang-format on
        ),
    ...
    [LR_LRCTL] = LAYOUT_split_3x6_3_wrapper(
        ...
        _______, ___________________________________________,    __________________LRCTL_R2_________________, _______,
    ...
    [LR_WARZONE] = LAYOUT_split_3x6_3_wrapper(
        ...
        KC_LSFT, KC_3   , KC_X   , KC_C   , KC_V   , KC_4   ,    KC_5   , _______, _______, _______, _______, KC_LWIN,
                                   KC_M   , KC_SPC , KC_LALT,    KC_LWIN, SYSCTL , KC_ESC
        // clang-format on
        ),
};
