...
//                                 |      |      |      |
//                                 `--------------------'
[LR_COD] = LAYOUT_ergodox_pretty_wrapper(
        ...
        KC_LCTL, KC_A   , KC_S   , KC_D   , KC_F   , KC_G,                       __________________KBCTL_R2_________________, _______,
        ...
        _______, _______, _______, _______, KC_SPC ,                                      _______, _______, _______, _______, _______,
                                                  _______, _______,     _______, _______,
                                                           _______,     _______,
                                          KC_LALT, KC_M  , _______,     _______, _______, _______
    ),
