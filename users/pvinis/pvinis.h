...
#define _____________MOD_QWERTY_L2_________________  CTL_T(KC_A), SFT_T(KC_S), GUI_T(KC_D), KC_F       , KC_G
#define _____________MOD_QWERTY_R2_________________  KC_H       , KC_J       , GUI_T(KC_K), SFT_T(KC_L), CTL_T(KC_SCLN)
