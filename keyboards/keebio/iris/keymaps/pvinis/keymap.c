...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [LR_WARZONE] = LAYOUT_wrapper(
        // clang-format off
        _______, ________________NUMBERS_L__________________,                        ___________________________________________, _______,
        _______, _________________QWERTY_L1_________________,                        ___________________________________________, _______,
        KC_LCTL, _________________QWERTY_L2_________________,                        ___________________________________________, _______,
        _______, _________________QWERTY_L3_________________, KC_LWIN,      _______, ___________________________________________, _______,
